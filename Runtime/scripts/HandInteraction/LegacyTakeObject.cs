...
{
    public class LegacyTakeObject : MonoBehaviour
    {
        public bool isDebug
        {
            get => _isDebug;
        ...
        private void Take()
        {
            ...
            if (!hit.collider.GetComponent<XRGrabInteractable>() || !hit.collider.GetComponent<LegacyTakeObject>()) return;
        ...
        {
            if (_takeStyle != LegacyTakeObject.TakeStyle.hold) return;
