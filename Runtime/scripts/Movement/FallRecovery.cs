...
namespace jeanf.universalplayer
{
    ...
    public class FallRecovery : MonoBehaviour, IDebugBehaviour
    {
        ...
        [Validation("CharacterController is required — fall detection reads its grounded state and recovery moves it.")]
        [SerializeField] private CharacterController controller;
        [Tooltip("The transform that gets teleported back (the Player root).")]
        [Validation("Player root is required — it is the transform teleported back on a runaway fall.")]
        [SerializeField] private Transform playerRoot;
        [Validation("PlayerMovement is required — FreeCam flight and being seated are read from it to suppress false recoveries.")]
