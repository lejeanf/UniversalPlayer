...
namespace jeanf.universalplayer
{
    ...
    public class FpsCameraFeel : MonoBehaviour, IDebugBehaviour
    {
        ...
        [Validation("PlayerMovement is required — head bob / landing dip read speed and grounded state from it.")]
        [SerializeField] private PlayerMovement playerMovement;
        [Tooltip("The transform the yaw lives on (the CameraOffset). Used to measure turn rate for the roll.")]
        [Validation("Look transform (CameraOffset) is required — the turn-tilt roll measures turn rate from it.")]
