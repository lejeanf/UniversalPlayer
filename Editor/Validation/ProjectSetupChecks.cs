    ...
    public static class ProjectSetupChecks
    {
        ...
        private static SetupValidator.CheckResult CheckActiveInputHandling()
        {
            ...
            return new SetupValidator.CheckResult(check, SetupValidator.Severity.Warning,
                ...
                "UniversalPlayer only needs the new system: switch to 'Input System Package (new)' after checking your " +
                "project scripts for UnityEngine.Input usage (search for 'Input.GetKey', 'Input.GetAxis', 'Input.mousePosition').");
#else
