    ...
    public static class UniversalPlayerProjectValidation
    {
        ...
        public static List<BuildValidationRule> BuildRules(BuildTargetGroup group)
        {
            var rules = new List<BuildValidationRule>
            {
                ...
                Rule(OpenXrSetupChecks.ProfileChoiceCheck, () => OpenXrSetupChecks.CheckProfileChoice(group),
                    OpenSettings("Project/XR Plug-in Management/OpenXR")),
                Rule(OpenXrSetupChecks.RenderSettingsCheck, () => OpenXrSetupChecks.CheckRenderSettings(group),
                    OpenSettings("Project/XR Plug-in Management/OpenXR")),
                Rule(OpenXrSetupChecks.PackageVersionCheck, () => OpenXrSetupChecks.CheckPackageVersion(),
                    () => UnityEditor.PackageManager.UI.Window.Open(OpenXrSetupChecks.OpenXrPackageName)),
